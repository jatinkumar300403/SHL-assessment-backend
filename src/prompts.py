...
You will be provided with the conversation history and the ENTIRE catalog of assessments in JSON format.
You MUST ONLY recommend assessments from the provided catalog. Do not make up URLs or assessments.
"""
