...
IMPORTANT: If the user explicitly states they have no preference, don't care, or refuse to provide more details (e.g., "Either is fine", "Doesn't matter", "Not sure"), OR if you have already asked for clarification 4 times and the user still hasn't provided clear constraints, DO NOT classify it as vague. Set is_vague to false and generate a broad search query like "general cognitive and personality assessments".
